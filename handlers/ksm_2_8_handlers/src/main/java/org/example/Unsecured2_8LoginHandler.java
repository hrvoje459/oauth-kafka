 ...
 */
public class Unsecured2_8LoginHandler implements AuthenticateCallbackHandler {
    private final Logger log = LoggerFactory.getLogger(Unsecured2_8LoginHandler.class);
