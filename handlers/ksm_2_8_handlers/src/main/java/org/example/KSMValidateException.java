...
public class KSMValidateException extends KafkaException {

    public KSMValidateException(String message) {
        super(message);
    }

    public KSMValidateException(Throwable cause) {
        super(cause);
    }

    public KSMValidateException(String message, Throwable cause) {
        super(message, cause);
    }
