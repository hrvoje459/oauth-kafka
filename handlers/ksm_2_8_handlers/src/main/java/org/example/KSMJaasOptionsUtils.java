...
public class KSMJaasOptionsUtils {

    private static final Logger log = LoggerFactory.getLogger(KSMJaasOptionsUtils.class);

    private final Map<String, Object> options;

    public KSMJaasOptionsUtils(Map<String, Object> options) {
    ...
    public String validateString(String name) throws KSMValidateException {
        return validateString(name, true);
    }

    public String validateString(String name, boolean isRequired) throws KSMValidateException {
