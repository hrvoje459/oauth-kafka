...
public class KSMBasicOAuthBearerToken implements OAuthBearerToken {
    ...
    public KSMBasicOAuthBearerToken(String token,
                                 Set<String> scopes,
                                 long lifetimeMs,
    ...
    public String toString() {
        return new StringJoiner(", ", KSMBasicOAuthBearerToken.class.getSimpleName() + "[", "]")
                .add("token='" + token + "'")
                .add("scopes=" + scopes)
