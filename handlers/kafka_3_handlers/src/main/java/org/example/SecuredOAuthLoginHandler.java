...
public class SecuredOAuthLoginHandler implements AuthenticateCallbackHandler {

    private static final Logger log = LoggerFactory.getLogger(SecuredOAuthLoginHandler.class);
