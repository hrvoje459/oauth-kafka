 ...
 */
public class MojOAuthModul implements LoginModule {
    ...
    public void initialize(Subject subject, CallbackHandler callbackHandler, Map<String, ?> sharedState,
                           Map<String, ?> options) {
        log.info("Module Checkpoint 1 initialize");
        log.info("Module Checkpoint 1.1 subject: " + subject);
        log.info("Module Checkpoint 1.2 sharedState: " + sharedState);
        log.info("Module Checkpoint 1.3 options: " + options);
        log.info("Module Checkpoint 1.4 callbackHandler: " + callbackHandler);
        log.info("Module Checkpoint 1.5 callbackHandler Class: " + callbackHandler.getClass());
    ...
    public boolean login() throws LoginException {
        ...
        log.info("Module Checkpoint 2 login");
    ...
    private void identifyToken() throws LoginException {
        ...
        log.info("Module Checkpoint 3 identify token");
        OAuthBearerTokenCallback tokenCallback = new OAuthBearerTokenCallback();

        log.info("Module Checkpoint 3.1 {}", tokenCallback.token());
        try {
    ...
    private void identifyExtensions() throws LoginException {
        ...
        log.info("Module Checkpoint 4 identify extensions");
    ...
    public boolean logout() {
        ...
        log.info("Module Checkpoint 5 logout");
        if (loginState == LoginState.LOGGED_IN_NOT_COMMITTED)
    ...
    public boolean commit() {
        ...
        log.info("Module Checkpoint 6 commit");
    ...
    public boolean abort() {
        ...
        log.info("Module Checkpoint 7 abort");
        if (loginState == LoginState.LOGGED_IN_NOT_COMMITTED) {
    ...
    private int committedTokenCount() {
        ...
        log.info("Module Checkpoint 8 commited token count");
