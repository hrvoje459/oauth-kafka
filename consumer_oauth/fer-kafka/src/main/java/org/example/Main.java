...
public class Main {
    ...
    public static void main(String[] args) throws IOException, KeyManagementException, NoSuchAlgorithmException, ExecutionException, InterruptedException {
        ...
        */
        ...
        final Properties props = loadConfig("/Users/hrvojerom/faks/diplomski_projekt/oauth-kafka/consumer_oauth/fer-kafka/src/main/resources/application.properties");


        Producer<String, String> producer = new KafkaProducer<>(props);
        producer.send(new ProducerRecord<>("neki-drugi-topic-3", "dasdasdas", "23adsdasaads4"));
        ...
        */
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "kafka-java-getting-started-4446dsasdsa");
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");

        KafkaConsumer<String, String> consumer = new KafkaConsumer<>(props);
        consumer.subscribe(Arrays.asList("neki-drugi-topic-3"));
        while (true) {
